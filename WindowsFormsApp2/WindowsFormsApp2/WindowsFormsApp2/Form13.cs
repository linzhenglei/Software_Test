...
namespace WindowsFormsApp2
{
    public partial class Form13 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (num != "")
                {
                    SqlCommand com = new SqlCommand();
                    com.Connection = con;
                    string str1 = "select * from FillQuestion where num like'%" + num + "%' ";
                    com.CommandText = str1;
                    SqlDataAdapter sqlDataAdapter = new SqlDataAdapter();
                    sqlDataAdapter.SelectCommand = com;
                ...
                else { MessageBox.Show("请输入需要查询的填空题序号"); }
        ...
        private void 判断题库ToolStripMenuItem_Click(object sender, EventArgs e)
        {
